        ...
        <div class="w-full bg-[#c6c6c6]">
            ...
            <div class="p-2">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <div class="flex">
                            <CraftingTableSlot :item="slot_1" />
                            <CraftingTableSlot :item="slot_2" />
                            <CraftingTableSlot :item="slot_3" />
                        </div>
                        <div class="flex">
                            <CraftingTableSlot :item="slot_4" />
                            <CraftingTableSlot :item="slot_5" />
                            <CraftingTableSlot :item="slot_6" />
                        </div>
                        <div class="flex">
                            <CraftingTableSlot :item="slot_7" />
                            <CraftingTableSlot :item="slot_8" />
                            <CraftingTableSlot :item="slot_9" />
                        </div>
                    </div>
