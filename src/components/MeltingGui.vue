                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-2 mr-4">
                        ...
                        <div class="relative w-16 h-16 bg-[#8B8B8B] border-2 border-[#FFFFFF] border-t-[#373737] border-l-[#373737] group">
                            <img
                                :src="input_item.includes('ball') ? 'img/template_slimeball.png' : 'img/template_slime_block.png'"
                                class="w-full h-full object-contain"
                                :alt="inputColor"
                            >
                            <div class="absolute inset-0" :class="input_item.includes('ball') ? 'tint-slimeball' : 'tint-slimeblock'" :style="{backgroundColor: inputColor}"></div>
                            <div class="absolute inset-x-10 inset-y-7">
