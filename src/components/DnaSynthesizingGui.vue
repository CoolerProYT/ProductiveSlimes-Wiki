            ...
            <div class="p-2">
                <div class="flex items-center justify-between">
                   ...
                   <div class="flex items-center justify-between w-36">
                       <div class="h-48 flex flex-col justify-between">
                           <div class="relative w-16 h-16 bg-[#8B8B8B] border-2 border-[#FFFFFF] border-t-[#373737] border-l-[#373737] group">
                               <div class="bucket-container relative">
                                   ...
                                   >
                                   <div class="absolute inset-0 tint-dna" :style="{backgroundColor: inputColor1}"></div>
                                   ...
                                   <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block bg-gray-700 text-white text-xs rounded py-1 px-2 whitespace-nowrap">
                                       <p>{{ input_item_dna_1.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase()) }}</p>
                                   </div>
                               </div>
                           </div>
                           ...
                           <div class="relative w-16 h-16 bg-[#8B8B8B] border-2 border-[#FFFFFF] border-t-[#373737] border-l-[#373737] group">
                               <div class="bucket-container relative">
                                   <img
                                       ...
                                       class="w-full h-full object-contain"
                                   >
                                   <div class="absolute inset-0 tint-dna" :style="{backgroundColor: inputColor2}"></div>
                                   <div class="absolute inset-x-10 inset-y-7">
                                       <p class="text-4xl minecraft-font">1</p>
                                   </div>
                                   <!-- Tooltip -->
                                   <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block bg-gray-700 text-white text-xs rounded py-1 px-2 whitespace-nowrap">
                                       <p>{{ input_item_dna_2.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase()) }}</p>
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="relative w-16 h-16 bg-[#8B8B8B] border-2 border-[#FFFFFF] border-t-[#373737] border-l-[#373737] group">
                           <div class="bucket-container relative">
                               <img v-if="input_item !== 'mud'"
                                    :src="'https://minecraft-api.vercel.app/images/items/' + input_item + '.png'"
                                    class="w-full h-full object-contain">
                               <img v-else
                                    :src="'img/mud.webp'"
                               >
                    ...
                    <div class="relative">
                        ...
                        <div class="mr-4 relative">
                            ...
                            <div
                                ...
                                :style="{ width: progressWidth + 'px', zIndex: 0 }"
                            >
                        ...
                        <div class="absolute top-12 left-8">
                            <div class="relative w-16 h-16 bg-[#8B8B8B] border-2 border-[#FFFFFF] border-t-[#373737] border-l-[#373737] group">
                                <div class="bucket-container relative">
                                    <img :src="'https://minecraft-api.vercel.app/images/items/egg.png'" alt="Bucket" class="w-full h-full object-contain bucket">
                                    <div class="absolute inset-x-10 inset-y-7">
                                        <p class="text-4xl minecraft-font">1</p>
                                    </div>
                                    <!-- Tooltip -->
                    ...
                    <div class="relative w-16 h-16 bg-[#8B8B8B] border-2 border-[#FFFFFF] border-t-[#373737] border-l-[#373737] group">
                        <div class="bucket-container relative">
                            <img :src="'img/template_spawn_egg_bg.png'" class="w-full h-full object-contain">
                            <img :src="'img/template_spawn_egg_hl.png'" class="w-full h-full object-contain absolute top-0">
                            <div class="absolute inset-0 tint-egg-bg top-0" :style="{backgroundColor: outputBackgroundColor}"></div>
                            <div class="absolute inset-0 tint-egg-hl top-0" :style="{backgroundColor: outputHighlightColor}"></div>
                            <div class="absolute inset-x-10 inset-y-7">
                                <p class="text-4xl minecraft-font">1</p>
                            </div>
                            <!-- Tooltip -->
...
export default {
    props: ['input_item', 'output_item', 'input_count', 'input_item_dna_1', 'input_item_dna_2', 'inputColor1', 'inputColor2', 'outputBackgroundColor', 'outputHighlightColor'],
    data() {
        return {
            progressWidth: 0
        }
...
.tooltip {
    ...
    z-index: 1000000 !important; /* Ensure it appears above other elements */
}
@font-face {
